...
public class ProfesorMedioTiempo extends Profesor{
    ...
    public ProfesorMedioTiempo(String cedula, String nombres, String apellido, String carrera, int horasClase) {
    ...
    public String toString() {
        ...
        return this.getCedula()+";"+this.getNombres()+";"+this.getApellido()+"; ProfesorMedioTiempo; "+this.getHorasClase()+";"+t;
    }
